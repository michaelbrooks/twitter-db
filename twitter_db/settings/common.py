...
SECRET_KEY = r'6_&ppz2r6-x^^$z&mfgo=bj03*&3=+_)y1#=l&iv!b0j7yyr7d'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'twitter_db.context_processors.current_site',
    'twitter_db.context_processors.debug_mode',
)
...
LOCAL_APPS = (
    ...
    'twitter_db.apps.twitter_stream',
)
